class Deliverable < ActiveRecord::Base
  ...
  def unique_course_task_owner?
    if self.is_team_deliverable?
      duplicate = Deliverable.where(:course_id => self.course_id, :task_number => self.task_number, :is_team_deliverable => true, :creator_id => self.creator_id, :team_id => self.team_id).first
    else
